...
export const createTransactionService = async (
  ...
  // If transaction is recurring, calculate the next valid recurring date
...
export const duplicateTransactionService = async (
  ...
  // Create a duplicate with reset values and "Duplicate" label
...
export const updateTransactionService = async (
  ...
  // Recalculate recurring date if needed
...
export const scanReceiptService = async (
  ...
  try {
    ...
    if (!cleanedText) {
      return { error: "Could not read reciept  content" };
    }
